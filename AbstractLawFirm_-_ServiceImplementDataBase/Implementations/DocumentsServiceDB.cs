...
{
    public class DocumentsServiceDB : IDocumentsService
    {
        private AbstractLawFirmDbContext context;
        public DocumentsServiceDB(AbstractLawFirmDbContext context)
        {
            this.context = context;
        }
        public List<DocumentsViewModel> GetList()
        {
            List<DocumentsViewModel> result = context.Documents.Select(rec => new
           DocumentsViewModel
            {
                Id = rec.Id,
